<template>
    <div class="container" style="margin-top: 7rem;">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TIDENET LIMITED, No. 8-425F., No. 9, Songgao Rd., Xinyi Dist., Taipei City, Taiwan (R.O.C.)..</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to TideBit Wallet, accessible from <a href="https://wallet.tidebit.network" rel="external nofollow noopener" target="_blank">https://wallet.tidebit.network</a></p>
            </li>
            <li>
        ...
        <ul style="text-align: left;">
            <li>By email: info@tidewallet.io</li>
        </ul>
        <br>
        <br>
    </div>
